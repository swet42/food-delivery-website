...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://www.facebook.com/share/1E8ft37J4p/', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.instagram.com/_.swet._42?igsh=c2J3ZjI4Y2dlNGhm', color: '#E1306C', label: 'Instagram' },
